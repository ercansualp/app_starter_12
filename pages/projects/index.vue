  ...
  <div>
    ...
    <div class="bg-card rounded-lg shadow-sm border border-border-color overflow-hidden p-6 relative">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <LoadingOverlay :is-loading="isUpdatingProjectId === project.id" message="Siliniyor..." />
          <div>
...
const loadingMessage = ref('Projeler yükleniyor...')
...
const confirmDeleteProject = (project) => {
  confirmationConfig.value = {
    ...
    message: `"${project.name}" projesini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.`,
    confirmText: 'Sil',
